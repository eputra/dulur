<%-- 
    Document   : editpostprofile
    Created on : Dec 31, 2016, 1:32:44 PM
...
<div class="container">
    ...
    <form data-toggle="validator" method="post" action="action/profile/post/edit.jsp" class="post-komentar">
